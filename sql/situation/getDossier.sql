SELECT * FROM (	
	...
	(SELECT PSTP_LIBELLE FROM EXECUTION%ANNEE%.POSTE_COMPTABLE_ORIGINAL@dblcca2 pc WHERE M.ASSIGNATAIRE=pc.PSTP_CODE) as ASSIGNATAIRE,
	(SELECT PSTP_LIBELLE FROM EXECUTION%ANNEE%.POSTE_COMPTABLE_ORIGINAL@dblcca2 pc WHERE M.MANDATAIRE=pc.PSTP_CODE) as MANDATAIRE,
	m.MAND_VISA_TEF,
	m.MAND_NUM_INFO,  
	m.MAND_OBJET,
	m.MAND_DATE_RECUP,
