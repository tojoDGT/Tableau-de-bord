		...
		<div class="content-wrapper">
			<section class="content-header">
			  ...
			  <ol class="breadcrumb">
				...
				<li><a href="#"><i class="fa fa-th"></i> Gestion des usages</a></li>
				...
				<div class="col-xs-12">
				  <div class="box">
					<div class="box-header">
					  <a href="{$zBasePath}usager/edit" class="btn btn-primary">Ajouter un {$oData.zLibelle1|lower}</button></a> 
					</div>
					<!-- /.box-header -->
					<div class="box-body">
					  <!------------------------------------------------------------->
