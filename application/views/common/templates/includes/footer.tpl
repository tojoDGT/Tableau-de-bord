 ...
 <!-- Control Sidebar -->
  <aside class="control-sidebar control-sidebar-dark">
			...
			<div class="p-3 control-sidebar-content" style="">
				...
				<div class="mb-2"><input type="checkbox" {if COMMUNE|in_array:$oDataTempCol} checked="checked" {/if} value="COMMUNE-m.COMMUNE" class="mr-1" name="colonneAffiche[]" /><span>COMMUNE</span></div>

				<div class="mb-2"><input type="checkbox" {if ASSIGNATAIRE|in_array:$oDataTempCol} checked="checked" {/if} value="Assignataire-m.ASSIGNATAIRE" class="mr-1" name="colonneAffiche[]" /><span>Assignataire</span></div>
				<div class="mb-2"><input type="checkbox" {if MANDATAIRE|in_array:$oDataTempCol} checked="checked" {/if} value="Mandataire-m.MANDATAIRE" class="mr-1" name="colonneAffiche[]" /><span>Mandataire</span></div>
				...
				<div class="mb-2"><input type="checkbox" {if MAND_NUM_INFO|in_array:$oDataTempCol} checked="checked" {/if} value="Numéro Info-m.MAND_NUM_INFO" class="mr-1" name="colonneAffiche[]" /><span>Numéro Info</span></div>
