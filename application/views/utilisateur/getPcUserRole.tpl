															  ...
															  <div class="card-body box-profile">
																...
																<table>
																	<tr>
																		<th>Fonction</th>
																		<th>Entité</th>
																		<th>Adresse d'activité</th>
																		<th>Libellé Rôle</th>
																	</tr>
																	{foreach from=$toGetInfoAgent item=$oGetInfoAgent}
																	<tr>
																		<td>{$oGetInfoAgent.ACTIVITYFUNCTION}</td>
																		<td>{$oGetInfoAgent.ACTIVITYNAME}</td>
																		<td>{$oGetInfoAgent.ACTIVITYADRS}</td>
																		<td>{$oGetInfoAgent.ROLETYPELIB}</td>
																	</tr>
																	{/foreach}
																</table>
															...
															<td>
																	<div class="form-group clearfix">
																		  <div class="icheck-success d-inline">
																			<input type="radio" name="radioDanger{$iIncrement}" {if $oGetAllApplication.ROLEAPPLIID|in_array:$toApplicationId} checked="checked" {else} disabled="" {/if} id="radioDanger{$iIncrement}">
