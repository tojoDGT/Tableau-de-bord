...
<div class="form-group mb-0">
	<div class="form-group">
		<label for="exampleInputEntite1">Intitulé pour le champ boucle (ex: combien d'etage ?) </label>
		...
		<input type="hidden" name="nbBoucle" id="nbBoucle"/>
	</div>
</div>
<br/>
<div style="text-align:right;padding-right: 1.25rem;">
<input style="width: 250px;" type="button" name="btnAddChamp" iTypeCible="2" incrementCible="nbrLigneCheck" tableCible="tableAddCheckRender" class="btn  bg-green AddLigne" value="Ajouter un nouveau choix (radio)" autocomplete="off">
<input type="hidden" name="nbrLigneCheck" id="nbrLigneCheck" value="1" autocomplete="off">
</div>
<br/>
<table class="table table-bordered" id="tableAddCheckRender">
  <thead>
		<tr>
  ...
  <tbody>
		<tr>
			...
			<td>
				<div class="item-cont">
					<input type="text" name="champNom[]" id="champNom_1" class="input input-sm form-control obligatoire" value="" />
					<p class="message">Champ obligatoire</p>
				</div>
			</td>
			<td>
