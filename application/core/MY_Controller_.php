	...
	function __construct()
		{
			...
			$this->load->model('Spo_model', 'spo');
			$this->load->model('Zone_model', 'zone');
			$this->load->model('Societariat_model', 'societariat');
			$this->load->model('SocietariatAssurance_model', 'societariatAssurance');
			$this->load->model('ActiviteAssurance_model', 'activiteAssurance');
			$this->load->model('EncourActivite_model', 'encourActivite');
			$this->load->model('PorteFeuille_model', 'porteFeuille');
			$this->load->model('EpargneActivite_model', 'epargneActivite');
			$this->load->model('SFinancier_model', 'sfinancier');
			$this->load->model('Information_model', 'information');
			$this->load->model('PoAssurance_model', 'poAssurance');
			$this->load->model('Parametre_model', 'parametre');
			$this->load->model('Repartition_model', 'repartition');
			$this->load->model('EpargneOffert_model', 'epargneOffert');
			$this->load->model('ActiviteCem_model', 'activiteCem');
			$this->load->model('CemFinancier_model', 'cemFinancier');
			$this->load->model('PoPoste_model', 'poPoste');
			$this->load->model('PoActivite_model', 'poActivite');
			$this->load->model('Eme_model', 'eme');
			$this->load->model('Imprimer_model', 'imprimer');
			$this->load->model('AutreVolumeActivite_model', 'autreVolumeActivite');
